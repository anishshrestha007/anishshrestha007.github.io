...
function header() {
  ...
  <label id="header-label-second" for="header-second">Menu</label>

  <input type="radio" name="header-name" id="header-third"></input>
  <label id="header-label-third" for="header-third">Contact</label>
`;
